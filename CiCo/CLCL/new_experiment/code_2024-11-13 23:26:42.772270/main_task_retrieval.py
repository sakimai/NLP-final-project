...
def main():
    ...
    if DATALOADER_DICT[args.datatype]["test"] is not None and args.local_rank == 0:
        full_test_dataloader, test_length = DATALOADER_DICT[args.datatype]["test"](args, tokenizer)
        ...
        test_dataloader = torch.utils.data.DataLoader(subset_test_dataset, batch_size=args.batch_size_val, shuffle=False)
