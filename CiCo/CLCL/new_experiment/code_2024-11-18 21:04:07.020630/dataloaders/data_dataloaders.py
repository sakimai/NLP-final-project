...
def dataloader_ph_test2(args, tokenizer, subset="test"):
    hp_testset = ph_DataLoader(
        subset=subset,
        data_path=args.data_path,
        features_path=args.features_path,
    ...
    # Create a subset with only the first 4 samples
    limited_testset = Subset(hp_testset, range(4))
    ...
    return dataloader_ph, len(limited_testset)
...
DATALOADER_DICT["ph"] = {"train":dataloader_ph_train, "dev":dataloader_h2s_test, "test":dataloader_ph_test, "test2":dataloader_ph_test2}
